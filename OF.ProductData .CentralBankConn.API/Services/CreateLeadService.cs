...
public class CreateLeadService : ICreateLeadService
{
    ...
    public async Task<ApiResult<CbsCreateLeadResponse>> GetProductFromCoreBankAsync(CbsCreateLeadRequest cbProductRequest)
    {
        ...
        try
        {
            ...
            if (apiResponse.IsSuccessStatusCode)
            {
                ...
                var coreBankProductResponse = JsonConvert.DeserializeObject<CbsCreateLeadResponse>(apiResponseBody) ?? throw new InvalidOperationException("Deserialized coreBankProductResponse is null.");
    ...
    public CbProductDataResponse GetCentralBankProductByIdResponse(CbsCreateLeadResponse cbProductResponse, Logger logger)
    {
